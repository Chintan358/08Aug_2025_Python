...
# --- Main Window ---
root = ttk.Window(themename="superhero")  # try "darkly", "superhero", "flatly"
...
ttk.Button(btn_frame, text="✏️ Update", bootstyle="warning", width=12, command=update_data).grid(row=0, column=1, padx=8)
